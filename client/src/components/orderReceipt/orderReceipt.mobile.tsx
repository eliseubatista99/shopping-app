  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={{ fontSize: "16px", fontWeight: 600, marginTop: "20px" }}>
          {i18n.details.title}
        </Text>
        ...
        >
          ...
          >
            {productColumn([
              ...
              ...(order.products || []).map((p) => i18n.details.price.value(p)),
            ])}
            ...
            {productColumn([
              ...
              ...(order.products || []).map((p) => i18n.details.total.value(p)),
            ])}
          </View>
        </View>
        ...
        >
          ...
          {totalCostsLine(i18n.summary.total.text, i18n.summary.total.value)}
        </View>
      </Page>
    </Document>
  );
